...
class CustomUserCreationFormTest(TestCase):
    ...
    def test_form_save_creates_user(self):
        ...
        self.assertEqual(user.username, self.valid_data['email'])  # Username should be set to email
...
class AccountsViewsTest(TestCase):
    ...
    def test_logout_view_requires_login(self):
        ...
        self.assertRedirects(response, f"{reverse('accounts:login')}?next={reverse('accounts:logout')}")
