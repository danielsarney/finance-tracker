...
def generate_invoice_pdf(invoice, output_path):
    ...
    line_items_table = Table(line_items_data, colWidths=[3*inch, 1.5*inch, 1*inch, 1.5*inch])
    ...
    # Payment terms
    payment_terms = Paragraph("PAYMENT DUE WITHIN 30 DAYS", 
                            ParagraphStyle('PaymentTerms', 
                                         alignment=TA_CENTER, 
                                         fontSize=12, 
                                         fontName='Helvetica-Bold'))
