...
class FinancialSummary(models.Model):
    ...
    total_subscriptions = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    total_work_income = models.DecimalField(max_digits=12, decimal_places=2, default=0.00)
