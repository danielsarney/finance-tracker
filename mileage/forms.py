...
class MileageLogForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Add help text
        self.fields["miles"].help_text = (
            "Enter the number of miles driven (can include decimals)"
        )
    ...
    def clean(self):
        ...
        if (
            start_location
            and end_location
            and start_location.lower() == end_location.lower()
        ):
