...
class BaseCRUDMixin(BaseListViewMixin):
    ...
    def create_view(self, request):
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                instance.save()
                messages.success(request, self.success_message or f'{self.model.__name__} created successfully!')
        ...
        return render(request, self.template_name, {
            'form': form, 
            'title': f'Add New {self.model.__name__}'
        })
    ...
    def delete_view(self, request, pk):
        ...
        return render(request, f'{self.model._meta.app_label}/{self.model._meta.model_name}_confirm_delete.html', {
    ...
    def detail_view(self, request, pk):
        """Handle detail view."""
        instance = get_object_or_404(self.model, pk=pk, user=request.user)
        return render(request, f'{self.model._meta.app_label}/{self.model._meta.model_name}_detail.html', {
            self.model._meta.model_name: instance
        })

def create_crud_views(model, form_class, template_name, list_url_name, success_message=None):
    """
    ...
    def list_view(request):
        ...
        return render(request, f'{model._meta.app_label}/{model._meta.model_name}_list.html', context)
