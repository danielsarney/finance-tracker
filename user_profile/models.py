...
class UserProfile(models.Model):
    ...
    address_line_1 = models.CharField(max_length=200, help_text="Your business address line 1")
    address_line_2 = models.CharField(max_length=200, blank=True, help_text="Your business address line 2 (optional)")
    ...
    account_number = models.CharField(max_length=20, help_text="Your bank account number")
    account_name = models.CharField(max_length=100, help_text="Name on the account")
    sort_code = models.CharField(max_length=10, help_text="Your bank sort code (e.g., 12-34-56)")
