...
class CategoryModelTest(TestCase):
    ...
    def test_category_usage_methods(self):
        ...
        self.assertEqual(
            category.get_usage_breakdown(),
            {"expenses": 0, "income": 0, "subscriptions": 0},
        )
    ...
    def test_category_usage_with_expenses(self):
        ...
        self.assertEqual(
            category.get_usage_breakdown(),
            {"expenses": 1, "income": 0, "subscriptions": 0},
        )
    ...
    def test_category_usage_with_income(self):
        ...
        self.assertEqual(
            category.get_usage_breakdown(),
            {"expenses": 0, "income": 1, "subscriptions": 0},
        )
    ...
    def test_category_usage_with_subscriptions(self):
        ...
        self.assertEqual(
            category.get_usage_breakdown(),
            {"expenses": 0, "income": 0, "subscriptions": 1},
        )
...
class CategoryFormTest(TestCase):
    ...
    def test_category_form_valid_data(self):
        ...
        form_data = {"name": "Test Category", "icon": "fa-utensils", "color": "#ff0000"}
...
class CategoryViewTest(TestCase):
    ...
    def test_category_update_view_get(self):
        ...
        response = self.client.get(
            reverse("categories:category_update", kwargs={"pk": self.category.pk})
        )
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "categories/category_form.html")
        self.assertIn("form", response.context)
    ...
    def test_category_update_view_nonexistent(self):
        ...
        response = self.client.get(
            reverse("categories:category_update", kwargs={"pk": 99999})
        )
    ...
    def test_category_delete_view_get(self):
        ...
        response = self.client.get(
            reverse("categories:category_delete", kwargs={"pk": self.category.pk})
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_category_delete_view_post(self):
        ...
        response = self.client.post(
            reverse("categories:category_delete", kwargs={"pk": category_pk})
        )
        self.assertEqual(response.status_code, 302)  # Redirect after success
    ...
    def test_category_delete_view_nonexistent(self):
        ...
        response = self.client.post(
            reverse("categories:category_delete", kwargs={"pk": 99999})
        )
        self.assertEqual(response.status_code, 404)
    ...
    def test_category_detail_view(self):
        ...
        response = self.client.get(
            reverse("categories:category_detail", kwargs={"pk": self.category.pk})
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_category_detail_view_with_usage(self):
        ...
        # Get the detail view
        response = self.client.get(
            reverse("categories:category_detail", kwargs={"pk": used_category.pk})
        )
    ...
    def test_category_detail_view_nonexistent(self):
        ...
        response = self.client.get(
            reverse("categories:category_detail", kwargs={"pk": 99999})
        )
        self.assertEqual(response.status_code, 404)
