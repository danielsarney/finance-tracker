...
class Client(models.Model):
    ...
    address_line_1 = models.CharField(
        max_length=200, help_text="Company address line 1"
    )
    address_line_2 = models.CharField(
        max_length=200, blank=True, help_text="Company address line 2 (optional)"
    )
    ...
    hourly_rate = models.DecimalField(
        max_digits=8, decimal_places=2, help_text="Default hourly rate for this client"
    )
