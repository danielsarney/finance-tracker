...
class ClientViewsTest(TestCase):
    ...
    def test_client_list_search_functionality(self):
        ...
        response = self.client.get(
            reverse("clients:client_list"), {"search": self.test_client.company_name}
        )
        self.assertContains(response, self.test_client.company_name)
        ...
        response = self.client.get(
            reverse("clients:client_list"), {"search": another_client.contact_person}
        )
    ...
    def test_client_detail_requires_login(self):
        ...
        self.client.logout()
        response = self.client.get(
            reverse("clients:client_detail", kwargs={"pk": self.test_client.pk})
        )
        self.assertEqual(response.status_code, 302)  # Redirect to login
    ...
    def test_client_detail_user_isolation(self):
        ...
        response = self.client.get(
            reverse("clients:client_detail", kwargs={"pk": other_client.pk})
        )
    ...
    def test_client_update_requires_login(self):
        ...
        self.client.logout()
        response = self.client.get(
            reverse("clients:client_update", kwargs={"pk": self.test_client.pk})
        )
        self.assertEqual(response.status_code, 302)  # Redirect to login
    ...
    def test_client_update_user_isolation(self):
        ...
        response = self.client.get(
            reverse("clients:client_update", kwargs={"pk": other_client.pk})
        )
        self.assertEqual(response.status_code, 404)  # Should not be accessible
